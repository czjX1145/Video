...
public class MailUtil {
	//修改为自己的qq邮箱账号
	private static String myEmailAccount = "2366540863@qq.com";
	//修改为自己的邮箱授权码                                                                         vdkgybzseicudjgh  hkzefjygizesecde qkwykrhzrhwndhge jesbjfptpvrjeafb
	private static String myEmailPassword = "jesbjfptpvrjeafb";
	//如果用qq邮箱不用修改，如果用163邮箱，修改为smtp.163.com 

	private static String myEmailSMTPHost = "smtp.qq.com";
	
	private static String sendUser = "阿里集团";
