...
<html lang="zh-CN">
  ...
  <body>
    ...
    <div>
    	<div class="zhuti">
		  <form class="form-horizontal" action="${pageContext.request.contextPath }/admin/lecturer_manage/addlecturer.action">
		  <div class="form-group form-group-sm">
		    <label class="col-sm-2 control-label" for="formGroupInputLarge">名字:</label>
		    <div class="col-sm-10">
		      <input class="form-control" type="text" id="formGroupInputSmall" placeholder="主讲人姓名" name="speakerName">
		    </div>
		  </div>		 
		  <div class="form-group form-group-sm">
		    <label class="col-sm-2 control-label" for="formGroupInputLarge">主讲人:</label>
		    <div class="col-sm-10">
		      <input class="form-control" type="text" id="formGroupInputSmall" placeholder="主讲人职业" name="speakerJob">
		    </div>
		  </div>	 
		  <div class="form-group form-group-sm">
		    <label class="col-sm-2 control-label" for="formGroupInputLarge">头像图片:</label>
		    <div class="col-sm-10">
		      <input class="form-control" type="text" id="formGroupInputSmall" placeholder="主讲人头像地址,网络图片" name="speakerHeadUrl">
		    </div>
		  </div>
		  ...
		  <div class="form-group form-group-sm">
		    ...
		    <div class="col-sm-10">
		      <textarea class="form-control" id="formGroupInputSmall" name="speakerDescr"></textarea>
		    </div>
		  </div>
