...
<html lang="zh-CN">
  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div style="margin: 0 auto;" class="collapse navbar-collapse" id="bs-example-navbar-collapse-9">
    ...
    <p></p>
    <div class="zhuti">
    	<form class="form-horizontal" action="${pageContext.request.contextPath }/admin/course_manage/updatecourse.action">
		    ...
		    <div class="col-sm-10">      
		      <select class="form-control" id="formGroupInputSmall" name="subjectId">
		      	...
		      	<option value="${list.id }" ${courseById.subjectId == list.id?"selected":""  }>${list.subjectName }</option>
		      	</c:forEach>
		      </select>
		    </div>
		  </div> 
		  ...
		  <div class="form-group form-group-sm">
		    ...
		    <div class="col-sm-10">
		      <input class="form-control" type="text" id="formGroupInputSmall" name="courseName" value="${courseById.courseName }">
		    </div>
		  </div>
		  <div class="form-group form-group-sm">
		    <label class="col-sm-2 control-label" for="formGroupInputLarge">课程简介:</label>
		    <div class="col-sm-10">
		      <textarea class="form-control" type="text" id="formGroupInputSmall" name="courseDescr">${courseById.courseDescr }</textarea>
		    </div>
		  </div>
		  <input type="hidden" name="id" value="${courseById.id }"/>
