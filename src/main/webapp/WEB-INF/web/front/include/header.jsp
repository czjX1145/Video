	...
	<div class="container">
		...
		<c:if test="${not empty _front_user}">
			<div id="userBlock" style="float:right">
				<a href="/video/front/user/outlogin.action">退出</a>
				<a href="/video/front/user/index.action" id="account">${sessionScope._front_user.email }</a>
			</div>                                    
		</c:if>
		...
		<a target="_blank" href="/video/backstageLogin.action"><img src="${pageContext.request.contextPath }/img/we.png" draggable="false">后台管理</a>
