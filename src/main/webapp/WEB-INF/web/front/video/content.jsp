...
<div class="catalog">
	<div class="container">
		...
		<c:forEach items="${videoList}" var="video" >
			<div class="chapter">
				<p class="biaoti"><a href="${pageContext.request.contextPath }/videoResources/front/video/index.action?videoId=${video.id}&subjectId=${subjectId}">${video.videoTitle}</a></p>
