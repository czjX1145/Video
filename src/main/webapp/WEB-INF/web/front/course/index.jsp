...
<body class="w100">
							...
							<div class="thum" style="background-image: url(${video.videoImageUrl})"></div>
								...
								<div class="classify-v-info">
									...
									<span class="duration" title="视频时长">
										<img src="${pageContext.request.contextPath }/img/player.png" alt="">${video.videoLengthStr }</span>
								</div>
							</li>
						</c:forEach>
					</ul>
	...
	<script type="text/javascript">
		function getVideo(id){
			...
			location.href='${pageContext.request.contextPath }/videoResources/front/video/index.action?videoId='+id+'&subjectId='+subjectId;
		}
	</script>
