...
<head>
    ...
    <%@include file="WEB-INF/web/front/include/style.jsp"%>
    <title>在线公开课-智游教育|java|大数据|HTML5|python|UI|PHP视频教程</title>
</head>

<body class="w100">
    <jsp:include page="WEB-INF/web/front/include/header.jsp"></jsp:include>
        ...
        <div class="container">
            ...
            <div class="course-info">
                <table cellspacing="10">
                    <tr>
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath }/videoResources/front/course/index.action?subjectId=1">
                        ...
                        <td>
                            <!--上线时修改id-->
                            <a href="${pageContext.request.contextPath }/videoResources/front/course/index.action?subjectId=6">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath }/videoResources/front/course/index.action?subjectId=10">
                    ...
                    <tr>
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath }/videoResources/front/course/index.action?subjectId=11">
    ...
    <%@include file="WEB-INF/web/front/include/footer.jsp"%>
    
    <%@include file="WEB-INF/web/front/include/script.jsp"%>
